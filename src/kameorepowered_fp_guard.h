...
inline std::atomic<uint64_t> g_kameo_fp_exception_count{0};
inline std::atomic<uint32_t> g_kameo_fp_last_code{0};
inline std::atomic<uint32_t> g_kameo_fp_last_mxcsr{0};
inline std::atomic<uint64_t> g_kameo_fp_last_rip{0};
